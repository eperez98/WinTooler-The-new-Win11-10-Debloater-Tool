...
function Show-MainMenu {
    ...
    Draw-MenuItem "C" "[G]" "Launch CTT PrettyWinUtil"      "Download and run EnziTheViking PrettyWinUtil GUI (online)"
...
# -----------------------------------------------
#  C - LAUNCH CTT PRETTYWINIUTIL
# -----------------------------------------------
function Launch-PrettyWinUtil {
    Draw-SectionHeader "[G]" "CTT PRETTYWINIUTIL (EnziTheViking Fork)"
